...
import {addTodoToState, toggleTodoOnState} from './actions';
 class Todos extends Component {
    ...
    render(){
        return(
            <div>
                <span> Add todo:</span> <input type="text" value ={this.state.todo} onChange={this.inputChange}/>
...
export default connect(mapStateToProps, {addTodoToState, toggleTodoOnState})(Todos)
//take stuf fand link it to component